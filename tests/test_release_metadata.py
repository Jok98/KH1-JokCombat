...
def test_release_versions_are_consistent() -> None:
    ...
    assert f"## {VERSION} - 2026-08-16" in read("CHANGELOG.md")
...
def test_release_manifest_is_minimal_and_complete() -> None:
    ...
    assert '    "v2.2.0"' not in build_script
    assert '[string]$Version = "v2.2.0"' in build_script
...
def main() -> None:
    ...
    print("PASS: v2.2.0 release metadata and nine-file manifest are consistent")
